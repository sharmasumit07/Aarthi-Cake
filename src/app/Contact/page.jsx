...
import { FaMapMarkerAlt, FaPhoneAlt, FaTruck, FaLink, FaFacebookF, FaInstagram } from 'react-icons/fa';
      ...
      <main className="container mx-auto px-4 py-24">
        ...
        >
          <Image
            ...
            height={400}
          />
          <div className="absolute inset-0 bg-[#E52A74] bg-opacity-40 flex flex-col items-center justify-center text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-2xl font-bold text-[#E52A74] mb-4 flex items-center">
              <Store className="w-6 h-6 mr-2 text-[#373281]" /> Ambattur Aarthi Sweets & Bakery
            </h2>
            <p className="text-lg text-[#373281] mb-4">
              No. 4/853, Ground Floor Perumbakkam Main Road, Medavakkam, Chennai, Tamil Nadu 600100
            </p>

            <h3 className="text-xl font-semibold text-[#E52A74] mb-2 flex items-center">
              <Clock className="w-6 h-6 mr-2 text-[#373281]" /> Store Hours
            </h3>
            <p className="text-lg text-[#373281] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#E52A74] mb-2 flex items-center">
              <MapPin className="w-6 h-6 mr-2 text-[#373281]" /> Our Locations
            </h3>
            <div>
            ...
            <h3 className="text-xl font-semibold text-[#E52A74] mb-2 flex items-center">
              <Truck className="w-6 h-6 mr-2 text-[#373281]" /> Home Delivery
            </h3>
